...
<nav class="bg-secondary" x-data="{ menuOpen: false, profileMenuOpen: false }">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
            ...
            -->
                    <svg class="block h-6 w-6 stroke-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                @auth
                    ...
                    <div class="ml-3 relative">
                        <div>
                            <button type="button" @click="profileMenuOpen = ! profileMenuOpen" @click.away="profileMenuOpen = false"
