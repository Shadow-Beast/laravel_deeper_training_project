    ...
    <div class="flex flex-wrap lg:-m-4 -m-2" x-data="MeetingCRUD">
        ...
        @auth
            ...
            <div x-show="detailModalOpen"
                ...
                <div class="px-4 z-30" @click.away="closeDetailModal()">
                    <!-- Modal content -->
            ...
            <div x-show="saveModalOpen"
                ...
                <!-- Blank Screen -->
                <div class="fixed bg-secondary/[0.5] w-full h-full z-20 inset-0"></div>
                <div class="w-[80%] px-4 z-30" @click.away="closeSaveModal()">
                    <!-- Modal content -->
                    <div class="rounded-lg shadow bg-secondary p-4">
                        ...
                        <div class="p-6 text-center">
                            <form id="saveForm" class="w-full -mx-2 flex flex-wrap text-left"
                                action="{{ route('meeting.save') }}" method="POST">
                                @csrf
                                ...
                                <div class="w-1/2 px-2">
                                    ...
                                    <div class="w-full mt-2">
                                        ...
                                        <x-form.textarea name="description" id="input-description" placeholder="description">
                                        </x-form.textarea>
                                        <x-error-message name="description"></x-error-message>
                                    </div>
                                    <div class="w-full mb-2">
                                        <label for="meeting_id" class="w-full">Meeting ID <span
                                                class="text-muted">(Optional)</span></label>
                                        <x-form.input type="text" name="meeting_id" id="input-meeting-id" placeholder="meeting id">
                                            </x-form-input>
                                            <x-error-message name="meeting_id"></x-error-message>
                                    </div>
                                    <div class="w-full my-2">
                                        <label for="start_at" class="w-full">Start At</label>
                                        <x-form.input type="datetime-local" name="start_at"  id="input-start-at" style="color-scheme: dark;">
                                            </x-form-input>
                                ...
                                <div class="w-1/2 px-2">
                                    ...
                                    <div class="w-full my-2">
                                        ...
                                        <x-form.input type="url" name="url" id="input-url" placeholder="http://example.com/">
                                            </x-form-input>
                                    ...
                                    <div class="w-full my-2">
                                        ...
                                        <x-form.input type="time" name="duration" id="input-duration" style="color-scheme: dark;">
                                            </x-form-input>
            ...
            <div x-show="deleteConfirmModalOpen"
                ...
                <!-- Blank Screen -->
                <div class="fixed bg-secondary/[0.5] w-full h-full z-20 inset-0"></div>
                <div class="px-4 z-30" @click.away="closeDeleteConfirmModal()">
                    <!-- Modal content -->
